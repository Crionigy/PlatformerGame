...
public class Player extends Entity{
    ...
    private float xDrawOffSet = 21 * EnvValues.SCALE;
    private float yDrawOffSet = 4 * EnvValues.SCALE;

    public Player(float x, float y, int width, int height) {
        super(x, y, width, height, 1.0f);
        movement = new Movement();
        loadAnimations();
        initHitBox((int) (20 * EnvValues.SCALE), (int) (27 * EnvValues.SCALE));
    }
